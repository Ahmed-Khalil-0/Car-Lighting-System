...
; This file was generated Tue Oct 29 15:21:39 2019
;--------------------------------------------------------
...
; global declarations
;--------------------------------------------------------
	global	_FrontLight_Get_Status
	global	_FrontLight_Update
	global	_FrontLight_Init
...
r0x1005	res	1
r0x1004	res	1
_FrontLight_Update_current_time_1_13	res	1
_frontLightStatus	res	1
;--------------------------------------------------------
; initialized data
;--------------------------------------------------------

ID_FrontLight_0	idata
_digital_Reading
	db	0x00, 0x00
...
; code
;--------------------------------------------------------
code_FrontLight	code
;***
;  pBlock Stats: dbName = C
;***
;entry:  _FrontLight_Get_Status	;Function start
; 2 exit points
;has an exit
;functions called:
;   __gptrput1
...
;  pBlock Stats: dbName = C
;***
;entry:  _FrontLight_Update	;Function start
; 2 exit points
;has an exit
;functions called:
;   _ADC_Update
...
;;	1028  _FrontLight_Update_current_time_1_13   offset=0
	BANKSEL	_FrontLight_Update_current_time_1_13
...
;  pBlock Stats: dbName = C
;***
;entry:  _FrontLight_Init	;Function start
; 2 exit points
;has an exit
;functions called:
;   _ADC_Init
...
;	  126+   45 =   171 instructions (  432 byte)
